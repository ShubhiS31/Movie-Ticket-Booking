		...
		<div class="row">
			...
			<div class="col-lg-4">
				...
				<h1 align="center" class="text-info">Welcome to Movie Ticket
					Booking!</h1>
				<br>
				<h2 align="center" text="b" font-size="3em">Login Page</h2>
				<br> <br>
				<h4 align="center" color="red">
					${SPRING_SECURITY_LAST_EXCEPTION.message}</h4>
				<br>
				...
				<form method="post" action="login">
					...
					<input name="password" type="password" class="form-control"
						...
						class="form-control btn btn-success" type="submit" value="Login" />
				...
				<input
						class="form-control btn btn-success" type="submit" value="Don't have an account? Register here" />
				</form>
			</div>
		</div>
	</div>
